...
export var repository = {"type":"git","url":"git+https://github.com/takuya-motoshima/xtejs-utils.git"};
...
export var author = "Takuya Motoshima <developer.takuyamotoshima@gmail.com> (https://twitter.com/taaaaaaakuya)";
export var license = "MIT";
export var bugs = {"url":"https://github.com/takuya-motoshima/xtejs-utils/issues","email":"developer.takuyamotoshima@gmail.com"};
export var homepage = "https://github.com/takuya-motoshima/xtejs-utils#readme";
export var devDependencies = {"@types/jest":"^24.0.23","fetch-mock":"^8.0.0","jest":"^24.9.0","json2module":"0.0.3","rollup":"^1.27.2","rollup-plugin-json":"^4.0.0","rollup-plugin-node-resolve":"^5.2.0","rollup-plugin-terser":"^5.1.2","rollup-plugin-typescript2":"^0.25.2","ts-jest":"^24.1.0","ts-node":"^8.5.2","tsconfig-paths":"^3.9.0","typescript":"^3.7.2"};
