...
export var devDependencies = {"@rollup/plugin-alias":"^3.0.1","@types/jest":"^24.0.23","fetch-mock":"^8.0.0","jest":"^24.9.0","json2module":"0.0.3","rollup":"^1.27.2","rollup-plugin-commonjs":"^10.1.0","rollup-plugin-javascript-obfuscator":"^1.0.4","rollup-plugin-json":"^4.0.0","rollup-plugin-node-resolve":"^5.2.0","rollup-plugin-terser":"^5.1.2","rollup-plugin-typescript2":"^0.25.2","ts-jest":"^24.1.0","ts-node":"^8.5.2","tsconfig-paths":"^3.9.0","typescript":"^3.7.2"};
export var dependencies = {"handlebars":"^4.7.3","moment":"^2.24.0"};
